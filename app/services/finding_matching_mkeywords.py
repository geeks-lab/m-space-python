...
# 예제 문장
text = "저는 오늘 감각적이고 멋지고 근사한 곳을 가고싶어요"
# 형용사 추출
extracted_adjectives = extract_adjectives(text)
# 결과 출력
print("extracted_adjectives:", extracted_adjectives)
...
model_path = '../assets/mymodelfromreviews/modelfromreviews2.model'
